...
func (v *BasePostgreSQLParserVisitor) VisitSimple_select(ctx *Simple_selectContext) interface{} {
	return v.VisitChildren(ctx)
}

func (v *BasePostgreSQLParserVisitor) VisitUnion(ctx *UnionContext) interface{} {
	return v.VisitChildren(ctx)
}

func (v *BasePostgreSQLParserVisitor) VisitIntersect(ctx *IntersectContext) interface{} {
	return v.VisitChildren(ctx)
}

func (v *BasePostgreSQLParserVisitor) VisitExcept(ctx *ExceptContext) interface{} {
	return v.VisitChildren(ctx)
}

func (v *BasePostgreSQLParserVisitor) VisitSet_operator_with_all_or_distinct(ctx *Set_operator_with_all_or_distinctContext) interface{} {
	return v.VisitChildren(ctx)
}
