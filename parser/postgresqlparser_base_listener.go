// Code generated from ./Golang/PostgreSQLParser.g4 by ANTLR 4.10.1. DO NOT EDIT.
...
func (s *BasePostgreSQLParserListener) EnterSimple_select(ctx *Simple_selectContext) {}

// ExitSimple_select is called when production simple_select is exited.
func (s *BasePostgreSQLParserListener) ExitSimple_select(ctx *Simple_selectContext) {}

// EnterUnion is called when production union is entered.
func (s *BasePostgreSQLParserListener) EnterUnion(ctx *UnionContext) {}

// ExitUnion is called when production union is exited.
func (s *BasePostgreSQLParserListener) ExitUnion(ctx *UnionContext) {}

// EnterIntersect is called when production intersect is entered.
func (s *BasePostgreSQLParserListener) EnterIntersect(ctx *IntersectContext) {}

// ExitIntersect is called when production intersect is exited.
func (s *BasePostgreSQLParserListener) ExitIntersect(ctx *IntersectContext) {}

// EnterExcept is called when production except is entered.
func (s *BasePostgreSQLParserListener) EnterExcept(ctx *ExceptContext) {}

// ExitExcept is called when production except is exited.
func (s *BasePostgreSQLParserListener) ExitExcept(ctx *ExceptContext) {}

// EnterSet_operator_with_all_or_distinct is called when production set_operator_with_all_or_distinct is entered.
func (s *BasePostgreSQLParserListener) EnterSet_operator_with_all_or_distinct(ctx *Set_operator_with_all_or_distinctContext) {
}

// ExitSet_operator_with_all_or_distinct is called when production set_operator_with_all_or_distinct is exited.
func (s *BasePostgreSQLParserListener) ExitSet_operator_with_all_or_distinct(ctx *Set_operator_with_all_or_distinctContext) {
}
