...
type PostgreSQLParserListener interface {
	...
	// EnterSet_operator_with_all_or_distinct is called when entering the set_operator_with_all_or_distinct production.
	EnterSet_operator_with_all_or_distinct(c *Set_operator_with_all_or_distinctContext)
	...
	// ExitSet_operator_with_all_or_distinct is called when exiting the set_operator_with_all_or_distinct production.
	ExitSet_operator_with_all_or_distinct(c *Set_operator_with_all_or_distinctContext)
